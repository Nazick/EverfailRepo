...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'everfaildb', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('C:\\xampp\\htdocs\\EverfailRepo\\src\\EverFail\\MainBundle\\Resources\\config\\doctrine' => 'EverFail\\MainBundle\\Entity', 'C:\\xampp\\htdocs\\EverfailRepo\\src\\FOS\\UserBundle\\Resources\\config\\doctrine' => 'FOS\\UserBundle\\Entity'));
        $d->setGlobalBasename('mapping');
        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'EverFail\\MainBundle\\Entity');
        $e->addDriver($d, 'FOS\\UserBundle\\Entity');
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('C:\\xampp\\htdocs\\EverfailRepo\\src\\FOS\\UserBundle\\Resources\\config\\doctrine\\model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\EverfailRepo\\src\\FOS\\UserBundle/Resources/views', 'FOSUser');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                ...
                1 => 'C:\\xampp\\htdocs\\EverfailRepo\\src\\FOS\\UserBundle\\Resources\\config\\validation.xml',
                2 => 'C:\\xampp\\htdocs\\EverfailRepo\\src\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml',
            ),
